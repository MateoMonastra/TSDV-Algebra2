...
namespace TP1_TP2
{
    ...
    {
        [Header("Unity´s Transform Hierarchy")]
        [SerializeField] private Transform unityHierarchyCube;
        
        [Header("My Transforms")]
        ...
        void Start()
        {
            _myCube.SetLocalPositionAndRotation(new Vec3(testCube.localPosition), new MyQuaternion (testCube.localRotation));
            ...
            _myCube2.SetLocalPositionAndRotation(new Vec3(testCube2.localPosition), new MyQuaternion (testCube2.localRotation));
            ...
            _myCube3.SetLocalPositionAndRotation(new Vec3(testCube3.localPosition), new MyQuaternion (testCube3.localRotation));
